<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"./themes/default/index\index.html";i:1529849907;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <meta name="description" content="BMS，全称Open Source Background System，基于ThinkPHP5开发的开源后台管理系统">
    ...
    <div class="top-nav">
        <div class="layui-main">
            ...
            <ul class="layui-nav">
                ...
                <li class="layui-nav-item"><a href="#" target="_blank">后台演示</a></li>
