<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./themes/admin/courseremach/index.html";i:1529725693;s:24:"./themes/admin/base.html";i:1529678839;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tbody>
                    <?php if(is_array($courseremach_list) || $courseremach_list instanceof \think\Collection || $courseremach_list instanceof \think\Paginator): if( count($courseremach_list)==0 ) : echo "" ;else: foreach($courseremach_list as $key=>$v): ?>
                    <tr>
                        ...
                        <td>
                            <?php if($v['state'] == 0): ?>
                            <a href="<?php echo url('admin/courseremach/download',['id'=>$v['id']]); ?>">下载</a>-
                            <a href="">晋级</a>-
                            <a href="<?php echo url('admin/courseremach/details',['id'=>$v['id']]); ?>">详情</a>
