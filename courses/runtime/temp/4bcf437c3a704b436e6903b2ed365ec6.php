<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./themes/admin/levyapi_user/index.html";i:1529842166;s:24:"./themes/admin/base.html";i:1529678839;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">API用户管理</li>
            <li class=""><a href="<?php echo url('admin/levyapi_user/add'); ?>">添加用户</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form layui-form-pane" action="<?php echo url('admin/levyapi_user/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/levyapi_user/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/levyapi_user/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
