<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./themes/admin/printgroup\index.html";i:1537344039;s:24:"./themes/admin/base.html";i:1536022750;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div class="layui-body"><!--style="overflow-x:scroll;width:1200px;white-space:nowrap;"-->
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">公司动态管理</li>
            <li class=""><a href="<?php echo url('admin/printgroup/add'); ?>">添加动态</a></li>
        </ul>
        <div class="layui-tab-content">
            <form class="layui-form layui-form-pane" action="<?php echo url('admin/printgroup/index'); ?>" method="get">
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <?php if(is_array($printgroup_list) || $printgroup_list instanceof \think\Collection || $printgroup_list instanceof \think\Paginator): if( count($printgroup_list)==0 ) : echo "" ;else: foreach($printgroup_list as $key=>$vo): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/printgroup/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/printgroup/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                ...
                <!--分页-->
                <?php echo $printgroup_list->render(); ?>
            </div>
        </div>
    </div>
</div>
