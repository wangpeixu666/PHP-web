<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./themes/admin/printnews\add.html";i:1536738311;s:24:"./themes/admin/base.html";i:1536022750;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/printnews/index'); ?>">新闻管理</a></li>
            <li class="layui-this">添加时事新闻</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/printnews/save'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="url" value="" placeholder="（选填）请输入url" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">来源</label>
                        <div class="layui-input-block">
                            <input type="text" name="source" value="" placeholder="（选填）请输入新闻来源" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
